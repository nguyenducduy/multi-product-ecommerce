  ...
  $('body').on('click', '#next', function () {
    ...
    if (answer == 'true') {
      if (question <= totalquestion) {
        ...
        htmlinfo +=
          '<input id="ffullname" class="p3input2" name="ffullname" type="text" placeholder="Họ và tên bạn"><label class="p3alert alertfullname"></label><div class="clear"></div>'
        htmlinfo +=
          '<input maxlength="15" id="fphoneguess" class="p3input2" name="fphone" type="text" placeholder="Điện thoại của bạn"><label  class="p3alert alertphone"></label><div class="clear"></div>'
        htmlinfo +=
          '<input id="femail" class="p3input2" name="femail" type="text" placeholder="Email của bạn"><label  class="p3alert alertemail"></label><div class="clear"></div>'
        htmlinfo +=
          '<input id="faddress" class="p3input2" name="faddress" type="text" placeholder="Địa chỉ của bạn"><label  class="p3alert alertaddress"></label><div class="clear"></div>'
        htmlinfo +=
      ...
      if (isNaN(answertext)) {
        ...
        if (question <= totalquestion) {
          ...
          htmlinfo +=
            '<input id="ffullname" class="p3input2" name="ffullname" type="text" placeholder="Họ và tên bạn"><label class="p3alert alertfullname"></label><div class="clear"></div>'
          htmlinfo +=
            '<input id="fphoneguess" class="p3input2" name="fphone" type="text" placeholder="Điện thoại của bạn"><label  class="p3alert alertphone"></label><div class="clear"></div>'
          htmlinfo +=
            '<input id="femail" class="p3input2" name="femail" type="text" placeholder="Email của bạn"><label  class="p3alert alertemail"></label><div class="clear"></div>'
          htmlinfo +=
            '<input id="faddress" class="p3input2" name="faddress" type="text" placeholder="Địa chỉ của bạn"><label  class="p3alert alertaddress"></label><div class="clear"></div>'
    ...
    if (pid) {
      ...
      if (document.readyState === 'complete') {
        Shadowbox.open({
          ...
          player: 'iframe',
          options: { modal: true },
          title: 'Rước đèn cùng dienmay.com',
          height: 200,
          width: 600,
        })
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 'ok') {
          ...
          $('.consultinghome').html(
            '<p>"Cảm ơn bạn ký đã đăng ký nhận tin từ dienmay. Bạn hãy kiểm tra hộp thư vừa đăng ký để xác nhận rằng bạn sở hữu email này. <br><br>(Vui lòng kiểm tra trong hộp thư rác nếu bạn không thấy email, hoặc liên hệ với bộ phận CSKH của dienmay qua hotline 1900 1883)"</p>'
          )
        }
        if (data == 'ext') {
...
function addproductbookmark() {
  ...
  $.ajax({
    ...
    success: function (resp) {
      var html =
        '<div class="popuplogin"><p class="title">Thông báo</p> <div class="popuplogin-bar">' +
        resp.data +
        '</div></div>'
      if (resp.error == 0) {
        ...
        Shadowbox.open({
          content:
            rooturl +
            'login/popuplogin?productid=' +
            $('#addproductbookmark').attr('rel') +
            '&barcode=' +
            $('#addproductbookmark').attr('data-barcode'),
          title: 'Đăng nhập ',
          player: 'iframe',
          width: 500,
          height: 250,
