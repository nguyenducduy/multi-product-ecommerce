          ...
          success : function(html){
              ...
              $.each(olddata,function(i){
                  if(olddata[i].randid > 0 )
                  {
                      ...
                      datahtml += "</div>";
                      datahtml += "<a href='javascript:void(0)'><img src='"+olddata[i].images.replace("http://dienmay.com","http://s.tgdt.vn") +"' title='"+olddata[i].name+"' alt='"+ olddata[i].name+"' /></a>";                       
                      datahtml += "<a href='javascript:void(0)' title='"+olddata[i].name+"'>"+olddata[i].name+"</a>";
                      datahtml += " <div class='price29b bortop292'>Giá thị trường: <strong>"+olddata[i].price+"đ</strong></div>"; 
                      datahtml += "<div class='price29n'>Giá bán tại dienmay.com ngày 02/09: <strong class='pricetrt1'>"+olddata[i].discountprice+"đ</strong></div>";
              ...
              if(typeof data.news !== 'undefined')
              {
					...
					datahtml += '<div class="buy29"><a class="inline291 buypromo0209" href="javascript:void(0)" rel="'+rooturl+'eventproducthours/addeventuser?pid='+newdata.pid+'">Mua ngay</a></div>';	
					datahtml += '<a href="javascript:void(0);"><img src="'+newdata.images.replace("http://dienmay.com","http://s.tgdt.vn")+'" title="'+newdata.name+'" alt="'+newdata.name+'" /></a>';	
					...
					datahtml += '<div class="price29n">Giá bán tại dienmay.com ngày 02/09: <strong class="pricetrt1">'+newdata.discountprice+'đ</strong></div>';	
