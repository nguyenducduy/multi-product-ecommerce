...
function GetCount(ddate,iid){
  ...
  // else date is still good
    ...
    if(hours != 0){out +="<div style='float:left'><span>"+ hours +"</span><strong>:</strong><b>Giờ</b></div>";}
