            ...
            var answertext = $("#answertext").val();
	            ...
	            if(answer == 'true'){
	            	if(question <= totalquestion){
	                    ...
	                    htmlinfo +='<input id="ffullname" class="p3input2" name="ffullname" type="text" placeholder="Họ và tên bạn"><div class="clear"></div>';
	            		htmlinfo +='<input maxlength="15" id="fphoneguess" class="p3input2" name="fphone" type="text" placeholder="Điện thoại của bạn"><div class="clear"></div>';
	            		htmlinfo +='<input id="femail" class="p3input2" name="femail" type="text" placeholder="Email của bạn"><div class="clear"></div>';
	            		htmlinfo +='<input id="faddress" class="p3input2" name="faddress" type="text" placeholder="Địa chỉ của bạn"><div class="clear"></div>';
	            	...
	            	if(isNaN(answertext)){
	            		...
	            		if(question <= totalquestion){
	            			...
	            			var htmlinfo ='<strong>Thông tin liên hệ</strong><span>Mời bạn để lại thông tin để nhận thông báo khi <i><a href="http://dienmay.com/" target="_blank" style="text-decoration:none;color:#00a1e6"><b>dienmay</b>.com</a></i> công bố kết quả</span>';
		                    htmlinfo +='<input id="ffullname" class="p3input2" name="ffullname" type="text" placeholder="Họ và tên bạn"><div class="clear"></div>';
		            		htmlinfo +='<input id="fphoneguess" class="p3input2" name="fphone" type="text" placeholder="Điện thoại của bạn"><div class="clear"></div>';
		            		htmlinfo +='<input id="femail" class="p3input2" name="femail" type="text" placeholder="Email của bạn"><div class="clear"></div>';
		            		htmlinfo +='<input id="faddress" class="p3input2" name="faddress" type="text" placeholder="Địa chỉ của bạn"><div class="clear"></div>';
		            		htmlinfo +='<label class="p3check"><input id="fcheckproduct" class="check" name="fcheckproduct" type="checkbox" checked value="1">Nhận thông báo qua email và tin nhắn khi sản phẩm này được bán</label><div class="clear"></div>';
