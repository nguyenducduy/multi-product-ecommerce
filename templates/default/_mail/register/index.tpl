...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="700" height="50" bgcolor="#0099FF" scope="row"><table width="681" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="143" height="43"><table cellspacing="0" cellpadding="0">
          <tr>
    ...
    <img src="{$registry->conf.rooturl}templates/default/images/mail/zr7l.png" alt="logoforum" width="20" height="20" /></a></td>
        <td width="41"><div align="left"><a href="https://plus.google.com/+dienmay/posts/">
        <img src="{$registry->conf.rooturl}templates/default/images/mail/82672377.png" alt="g+" width="20" height="20" /></a></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="11" align="center" valign="middle" bgcolor="fff200"></td>
  </tr>
  <tr>
    <td height="10"  bordercolor="#F0F0F0" bgcolor="#0099FF" scope="row"><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="15" scope="row"><div align="center"><span class="style8" style="font-size: 10px; font-family: arial; color: #FFFFFF;">ĐIỆN THOẠI - TABLET</span></div></td>
        <td><div align="center"><span class="style8" style="font-size: 10px; font-family: arial; color: #FFFFFF;">LAPTOP - IT</span></div></td>
        <td><div align="center"><span class="style8" style="font-size: 10px; font-family: arial; color: #FFFFFF;">ĐIỆN TỬ</span></div></td>
        <td height="15" scope="row"><p align="center" class="style8" style="font-size: 10px; font-family: arial; color: #FFFFFF;">ĐIỆN LẠNH</p></td>
        <td><div align="center"><span class="style8" style="font-size: 10px; font-family: arial; color: #FFFFFF;">GIA DỤNG</span></div></td>
        <td><div align="center"><span class="style8" style="font-size: 10px; font-family: arial; color: #FFFFFF;">PHỤ KIỆN</span></div></td>
      </tr>
      <tr>
        <td height="15" colspan="6" bgcolor="#FFFFFF" scope="row">
    <img src="{$registry->conf.rooturl}templates/default/images/mail/main-shadow.png" width="700" height="26" alt="shdow" /></td>
        </tr>
    </table></td>
  </tr>
</table>
<table width="700" align="center" cellpadding="0" cellspacing="0">
    <tr>
    <td height="274"><blockquote>
        <p align="justify" style="font-family:verdana; font-size:18px; color:#003366; font-weight:bold;">
          XÁC NHẬN ĐĂNG KÝ THÀNH CÔNG TỪ DIENMAY.COM</p>
...
<p align="right" style="font-family:verdana; font-size:13px; color:#003366">
          Trân trọng, <br /> <br />
          
          <strong>dienmay.com team</strong>
...
<table width="708" align="center" cellpadding="0" cellspacing="0" style="display:block">
