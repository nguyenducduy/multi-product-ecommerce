...
<head>
    ...
    <title>Xác nhận đặt hàng tại dienmay.com</title>
</head>
                        ...
                        <td style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #0d0d0d;">
                            <div style="margin-top: 10px;">
                                <h2 style="text-align: center;">
                                    XÁC NHẬN ĐẶT HÀNG TỪ <i>DIENMAY.COM</i></h2>
                                <div>
                                    ...
                                    <br />
                                    <br />
                                    <div style="background: #fafafa; border: 1px dotted #cccccc; padding: 10px;">
                                        <table style="width: 100%; font-size: 12px; border: 1px solid #fafafa;">
                                            <tr style="border-bottom: 1px solid #fafafa;">
                                                <td style="width: 30%; padding: 5px 0; border-bottom: 1px dotted #ccc;">
                                                    Mã đơn hàng
                                                </td>
                                                <td style="border-bottom: 1px dotted #ccc;">
                                                    <b style="color: Red; font-size: 14px; font-weight: bold;">{$formData.order->invoiceid|strtoupper}</b>
                                                </td>
                                            </tr>
                                            <tr style="border-bottom: 1px solid #fafafa; padding: 5px 0">
                                                <td style="width: 30%; padding: 5px 0; border-bottom: 1px dotted #ccc;">
                                                    Giá trị đơn hàng
                                                </td>
                                                <td style="font-weight: bold; border-bottom: 1px dotted #ccc;">
                                                    {$formData.order->pricefinal|number_format} đ
                                                </td>
                                            </tr>
                                            <tr style="border-bottom: 1px solid #fafafa; padding: 5px 0">
                                                <td style="width: 30%; padding: 5px 0; border-bottom: 1px dotted #ccc;">
                                            ...
                                            <tr style="border-bottom: 1px solid #fafafa; padding: 5px 0">
                                                ...
                                                <td style="font-weight: bold; border-bottom: 1px dotted #ccc;">
                                                    <p style="color: #818181; font-weight: normal; font-size: 11px;">
                                                        {$formData.order->paymentmethod}
                                                    </p>
                                                    <!--
                                                    <p style="color: #818181; font-weight: normal; font-size: 11px;">Bạn sẽ thanh toán tiền cho nhân viên giao hàng của <i><b>dienmay</b>.com</i>, sau khi nhận và kiểm tra hàng hóa.[Show dòng này nếu chọn thanh toán khi nhận hàng]<br />Công ty cổ phần Thế Giới Điện Tử <br />
STK: <strong>0441000614689</strong><br />
Ngân hàng Vietcombank, chi nhánh Tân Bình, TP. HCM [Show dòng này nếu chọn phương thức thanh toán qua chuyển khoản NH])</p> -->
                                                </td>
                                            </tr>
                                            <tr style="border-bottom: 1px solid #fafafa; padding: 5px 0; border-bottom: 1px dotted #ccc;">
                                                <td style="width: 30%; padding: 5px 0; border-bottom: 1px dotted #ccc;">
                                                    Địa chỉ nhận hàng
                                                </td>
                                                <td style="font-weight: bold; border-bottom: 1px dotted #ccc;;">
                                                    {$formData.order->billingaddress} ,{$formData.order->billingdistrict}, {$formData.order->billingregionid}
                                                </td>
                                            </tr>
                                            <tr style="border-bottom: 1px solid #fafafa; padding: 5px 0; border-bottom: 1px dotted #ccc;">
                                                <td style="width: 30%; padding: 5px 0; border-bottom: 1px dotted #ccc;">
                                            ...
                                            <tr style="border-bottom: 1px solid #fafafa; padding: 5px 0">
                                                ...
                                                <td style="font-weight: bold;">
                                                    {if $formData.order->promotionid != 38}
                                                        {if !empty($formData.order->note)} 
                                                            {$formData.order->note}
                                                        {/if}
                                                    {/if}
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <table width="100%" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr bgcolor="#0072cc">
                                                                <td width="50%" align="center" style="padding: 5px; font-weight: bold; color: #ffffff;
                                                                    font-family: arial; font-size: 12px">
                                                                    Tên sản phẩm
                                                                </td>
                                                                <td align="center" style="padding: 5px; font-weight: bold; color: #ffffff; font-family: arial;
                                                                    font-size: 12px">
                                                                    Đơn giá
                                                                </td>
                                                                <td align="center" style="padding: 5px; font-weight: bold; color: #ffffff; font-family: arial;
                                                            ...
                                                            <tr bgcolor="#FFFFCC">
                                                                <td style="padding: 5px; font-family: arial; font-size: 12px">
                                                                    {$orderdetailloop->product->name} <br />
                                                                    <i style="font-size: 11px;color: #646464;"><u>
                                                                    {if !empty($orderdetailloop->options->descriptionclone) ||  !empty($orderdetailloop->options->description)}
                                                                        Khuyến mãi:<br /></u></i><span style="font-size: 11px; color: #646464;">{if $orderdetailloop->options->descriptionclone != ''}
                                                                            {$orderdetailloop->options->descriptionclone}
                                                                        {else}
                                                                            {$orderdetailloop->options->description}
                                                                        {/if}</span>
                                                                    {else}
                                                                        {if !empty($orderdetailloop->product->prepaidpromotion)}
                                                                            {$orderdetailloop->product->prepaidpromotion}
                                                                        {/if}
                                                                    {/if}
                                                                    {if $formData.order->promotionid == 38}
                                                                        {if !empty($formData.order->note)} 
                                                                ...
                                                                <td align="center" style="padding: 5px; font-family: arial; font-size: 12px">
                                                                 {if $formData.order->promotionid == 38}
                                                                    {$orderdetailloop->product->prepaidprice|number_format} 
                                                                 {else}
                                                                    {if $orderdetailloop->pricefinal > 0}{$orderdetailloop->pricefinal|number_format} đ {else}{$orderdetailloop->pricesell|number_format} đ {/if}
                                                                {/if}
                                                                </td>
                                                                <td align="center" style="padding: 5px; font-family: arial; font-size: 12px">
                                                                   {$orderdetailloop->quantity}
                                                                </td>
                                                                <td align="center" style="padding: 5px; font-family: arial; font-size: 12px">
                                                                    {math|number_format equation="x*y" x=$orderdetailloop->pricefinal y=$orderdetailloop->quantity format="%.0f"} đ
                                                                </td>
                                                            </tr>
                                                            {/foreach}
                                                            <tr bgcolor="#0099CC">
                                                                <td colspan="4" align="right" style="padding: 10px; color: #fff; font-weight: bold;
                                                                    font-family: arial; font-size: 12px">
                                                                    Tổng cộng:  
                                                                    <span style="color:#FEF105; font-size: 14px;">{$formData.order->pricefinal|number_format} đ</span>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <p style="text-align: right; margin-right: 20px;">Trân trọng,<br /><i><b>dienmay</b>.com</i></p>
