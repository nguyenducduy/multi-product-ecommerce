        ...
        <table width="600" border="0" cellspacing="0" cellpadding="0" style="padding: 3px 0;
            ...
            <tr>
                ...
                <td width="240" style="float: right; background: #00a5e1; padding: 7px 3px; text-align: center;
                    ...
                    <a href="https://ecommerce.kubil.app/?utm_source=trigger-email&utm_medium=email-reset-password&utm_campaign=more-traffic-from-trigger-email&utm_content=footer-link-dienmay"
            ...
            <tr>
                <td width="400" style="font: normal 11px/18px arial; color: #111;">
                    <p style="font-size: 10px;">
                        ...
                        Website:<a href="https://ecommerce.kubil.app/?utm_source=trigger-email&utm_medium=email-reset-password&utm_campaign=more-traffic-from-trigger-email&utm_content=footer-link-dienmay"
                    ...
                    <div style="border-left: 1px solid #ccc; margin-top: 10px;">
                        ...
                        <div style="margin-top: 5px; margin-left: 10px; display: block;">
                                                    <span style="font: bold italic 15px arial; color: #00a1e5;"><i style="margin-right: 5px;">
                                                            <img src="https://ecommerce.kubil.app/uploads/pimages/email/icon-hotline.jpg" alt="Hotline 1900 1883" /></i>1900
                                                        1883</span><br>
                                                    <span style="font: bold italic 15px arial; color: #00a1e5; text-decoration: none;"><i
                                                                style="margin-right: 5px;"><a href="https://ecommerce.kubil.app/sieuthi/?utm_source=trigger-email&utm_medium=email-reset-password&utm_campaign=more-traffic-from-trigger-email&utm_content=footer-link-dienmay">
                                                                ...
                                                                href="https://ecommerce.kubil.app/sieuthi/?utm_source=trigger-email&utm_medium=email-reset-password&utm_campaign=more-traffic-from-trigger-email&utm_content=footer-link-dienmay"
