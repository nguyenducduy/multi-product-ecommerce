...
<body>
	...
	<form action="" method="post" name="myform" class="form-horizontal">
		<div>Nội dung</div><textarea class="input-xxlarge"  name="freviewcontent" id="freviewcontent" cols="" rows="" placeholder="Ý kiến của bạn">{$formData.freviewcontent}</textarea>&nbsp;<span style="color:red;display:none;" id="contentrequired">(*)</span><br />
    	<div style="padding-left:539px;"><input type="submit" name="fsubmit" value="Gửi" class="btn btn-large btn-primary" /></div>
	</form>
</body>