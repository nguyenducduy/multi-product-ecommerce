...
<div class="page-header" rel="menu_review_list"><h1>{$lang.controller.head_edit}</h1></div>
...
<input type="hidden" name="ftoken" value="{$smarty.session.reviewEditToken}" />
	...
	<div class="control-group">
		<label class="control-label" for="fxuid">Xu ID</label>
		<div class="controls">
			<input type="text" name="fxuid" id="fxuid" value="{$formData.fxuid|@htmlspecialchars}" class="input-mini">
		</div>
	</div>
