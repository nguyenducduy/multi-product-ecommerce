...
<div class="page-header" rel="menu_accessticket"><h1>{$lang.controller.head_edit}</h1></div>
...
<input type="hidden" name="ftoken" value="{$smarty.session.accessticketEditToken}" />
	...
	<div class="control-group">
		...
		<div class="controls"><span class="label label-info">{$formData.actor->fullname}</span></div>
	</div>	
