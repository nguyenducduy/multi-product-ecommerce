...
<div class="page-header" rel="menu_vendor"><h1>{$lang.controller.head_add}</h1></div>
...
<input type="hidden" name="ftoken" value="{$smarty.session.vendorAddToken}" />
	...
	<div class="control-group">
		...
		<div class="controls"><input type="file" name="fimage" id="fimage" value="">(JPG, GIF, PNG)</div>
	</div>
