<ul class="breadcrumb">
	...
	<li><a href="{$conf.rooturl}{$controllerGroup}/{$controller}">NewsReview</a> <span class="divider">/</span></li>
	<li class="active">{$lang.controller.head_edit}</li>
</ul>

<div class="page-header" rel="menu_newsreview"><h1>{$lang.controller.head_edit}</h1></div>

<div class="navgoback"><a href="{$redirectUrl}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal">
<input type="hidden" name="ftoken" value="{$smarty.session.newsreviewEditToken}" />
	...
	<div class="control-group">
		...
		<div class="controls"><input type="hidden" name="fobjectid" id="fobjectid" value="{$formData.fobjectid|@htmlspecialchars}"><b>{$formData.ftitle}</span></div>
	</div>
