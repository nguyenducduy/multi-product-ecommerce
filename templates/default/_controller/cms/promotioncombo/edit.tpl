...
<div class="page-header" rel="menu_promotioncombo"><h1>{$lang.controller.head_edit}</h1></div>

<div class="navgoback"><a href="{$redirectUrl}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal">
<input type="hidden" name="ftoken" value="{$smarty.session.promotioncomboEditToken}" />
	...
	<div class="control-group">
		<label class="control-label" for="fcoid">{$lang.controller.labelCoid}</label>
		<div class="controls"><input type="text" name="fcoid" id="fcoid" value="{$formData.fcoid|@htmlspecialchars}" class="input-xlarge"></div>
	</div>
