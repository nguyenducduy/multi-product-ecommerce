...
<input type="hidden" name="ftoken" value="{$smarty.session.productguessAddToken}" />
	...
	<div class="control-group">
		...
		<div class="controls"><textarea name="frule" id="frule" rows="7" class="input-xxlarge">{$formData.fbad}</textarea></div>
	</div>
