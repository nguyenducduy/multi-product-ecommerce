<ul class="breadcrumb">
	...
	<li><a href="{$conf.rooturl}{$controllerGroup}/{$controller}">Export user đoán giá</a> <span class="divider">/</span></li>
	<li class="active">{$lang.controller.head_add}</li>
</ul>

<div class="page-header" rel="menu_productguess"><h1>Export user đoán giá</h1></div>

<div class="navgoback"><a href="{$redirectUrl}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal">
<input type="hidden" name="ftoken" value="{$smarty.session.exportguessuserAddToken}" />
	...
	<div class="control-group">
		...
		<div class="controls"><input type="text" name="fpgid" id="fpgid" value="{$smarty.get.pgid}" class="input-large"></div>
	</div>
