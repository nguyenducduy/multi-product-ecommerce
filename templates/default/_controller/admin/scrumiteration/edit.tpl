...
<div class="page-header" rel="menu_scrumiteration"><h1>{$lang.controller.head_edit}</h1></div>

<div class="navgoback"><a href="{$smarty.session.backaction}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal">
<input type="hidden" name="ftoken" value="{$smarty.session.scrumiterationEditToken}" />
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" class="inputdatepicker" name="fdatestarted" id="fdatestarted" value="{$formData.fdatestarted|@htmlspecialchars}" >
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" class="inputdatepicker" name="fdateended" id="fdateended" value="{$formData.fdateended|@htmlspecialchars}" >
		</div>
	</div>
