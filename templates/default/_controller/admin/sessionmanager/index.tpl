<ul class="breadcrumb">
	...
	<li><a href="{$conf.rooturl_admin}{$controller}">Session Manager</a> <span class="divider">/</span></li>
	<li class="active">Listing</li>
</ul>

<div class="page-header" rel="menu_sessionmanager"><h1>Session Manager</h1></div>
						...
						<tr>
							<td colspan="9">
								...
								<div class="bulk-actions align-left">
									<input type="submit" name="btnDel" class="btn btn-danger" value="Delete Selected" />
								</div>
