	...
	<body class='login_body'>
		<div class="wrap">
			...
			<div style="padding:0 20px">
				<p>Hệ thống đã nhận được thông tin của bạn. Sau khi quá trình thêm vào phòng ban hoàn tất, team sẽ gởi báo cáo nội bộ đến <span class="label label-inverse">{$me->oauthUid}</span> để thông báo. 
				<p>Nếu sau 24 giờ mà chưa có phản hồi, bạn hãy liên hệ với các thành viên của phòng nhân sự hoặc bộ phận phát triển web để được hỗ trợ.</p>
				{if $me->email == '' || $me->password == '' || $me->phone == ''}
					<p><a class="btn btn-primary" href="{$conf.rooturl_admin}login/initemployee">Cập nhật một số thông tin bắt buộc &raquo;</a></p>
				{/if}
				<p style="padding:10px; border-top: 2px solid #eee; border-bottom:2px solid #eee;font-weight:bold;line-height:1.7;display:none;">
