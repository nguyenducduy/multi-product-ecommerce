<html>
	...
	<body class='login_body'>
		<div class="wrap">
			...
			<div class="login">
				<div class="email">
					<label for="user">{$lang.controller.email}</label><div class="email-input"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-envelope"></i></span><input type="text" id="femail" name="femail" class=""></div></div></div>
				</div>
				<div class="pw">
					<label for="pw">{$lang.controller.password}</label><div class="pw-input"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-lock"></i></span><input type="password" id="fpassword" name="fpassword" class=''></div></div></div>
				</div>
				<div class="remember">
					<label class="checkbox" title="{$lang.controller.remembermeTip}">
						<input type="checkbox" value="1" name="fremember"> <small>{$lang.controller.rememberme}</small>
					</label>
				</div>
			</div>
			<div class="submit">
				<a href="{$conf.rooturl_admin}forgotpass" style="color:#555;">{$lang.controller.forgotpass}</a>
				<input type="submit" name="fsubmit" class="btn btn-primary pull-right" style="margin-right:20px;" value="{$lang.controller.submitLabel}" />
			</div>
