<html>
	...
	<body class='login_body'>
		<div class="wrap">
			...
			<h2>Chức mừng bạn đã trở thành thành viên chính thức của hệ thống dienmay.com</h2>
			<h4>Mã tài khoản của bạn <span class="label label-success">{$me->getCode()}</span></h4>
			
			{if $error|@count == 0}
			<div style="padding:0 20px">
				<p style="color:#f30;">Là nhân viên, các thông tin bên dưới là bắt buộc nhập. <br />Với <strong>EMAIL</strong> và <strong>MẬT KHẨU</strong>, bạn có thể <b>ĐĂNG NHẬP TRỰC TIẾP</b> vào hệ thống nội bộ dienmay.com mà không cần tài khoản của Báo Cáo Nội Bộ.</p>
			</div>
			{/if}
			...
			<div class="login">
				<div class="email">
					<label for="user">{$lang.controller.email}</label><div class="email-input"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-envelope"></i></span><input type="text" id="femail" name="femail" value="{$formData.femail}" class=""></div></div></div>
				</div>
				<div class="email">
					<label for="user">Nhập lại email</label><div class="email-input"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-envelope"></i></span><input type="text" id="femail" name="femail2" value="{$formData.femail2}" class=""></div></div></div>
				</div>
				
				<div class="pw">
					<label for="pw">{$lang.controller.password}</label><div class="pw-input"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-lock"></i></span><input type="password" id="fpassword" name="fpassword1" class=''></div></div></div>
				</div>
				<div class="pw">
					<label for="pw">Nhập lại mật khẩu</label><div class="pw-input"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-lock"></i></span><input type="password" id="fpassword" name="fpassword2" class=''></div></div></div>
				</div>
				<div class="email">
					<label for="user">Số điện thoại</label><div class="email-input"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-phone"></i></span><input type="text" id="fphone" name="fphone" value="{$formData.fphone}" class=""></div></div></div>
				</div>
			</div>
			<div class="submit">
				<input type="submit" name="fsubmit" class="btn btn-primary pull-right" style="margin-right:20px;" value="Hoàn tất" />
			</div>
