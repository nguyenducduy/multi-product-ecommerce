...
<center>
		...
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
		  ...
		  <param name="src" value="{$conf.rooturl}templates/default/images/webcamsnap.swf?uploadfile={$conf.rooturl_profile}account/avatarwebcam" />
		  <param name="quality" value="high" />
		  <param name="wmode" value="opaque" />
		  <param name="bgcolor" value="#ffffff" />
		    <embed src="{$conf.rooturl}templates/default/images/webcamsnap.swf?uploadfile={$conf.rooturl_profile}account/avatarwebcam" quality="high"
