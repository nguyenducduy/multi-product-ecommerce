<script type="text/javascript" src="{$currentTemplate}js/profile/account.js"></script>
...
<div class="tabbable">
	<ul class="nav nav-tabs">
		<li {if $tab == '' || $tab == 1}class="active"{/if}><a href="#tab1" data-toggle="tab">{$lang.controller.titleAccount} {if $me->email != ''}&lt;{$me->email}&gt;{/if}</a></li>
		<li {if $tab == 2}class="active"{/if}><a href="#tab2" data-toggle="tab">{$lang.controller.tabProfile}</a></li>
		<li {if $tab == 3}class="active"{/if}><a href="#tab3" data-toggle="tab">{$lang.controller.tabChangepassword}</a></li>
	</ul>
	<div class="tab-content">
		...
		<div class="tab-pane {if $tab == '' || $tab == 1}active{/if}" id="tab1">
			
			

			<form action="{$conf.rooturl_profile}account" method="post" name="myform" class="form-horizontal">
					...
					<div class="controls">
						<div id="avatarform">
				        	<div class="form-avatar">
								...
								<div class="form-avatar-image"><img src="{$me->getSmallImage()}" alt="avatar placeholder" width="50" height="50" /></div>
								...
								<div class="form-avatar-buttons"{if $me->avatar != ''} style="display:none;"{/if}>
									<a href="{$conf.rooturl_profile}account/avatarupload" rel="shadowbox;width=960px;height=640px"><img src="{$imageDir}admin/avatar-btn-upload.gif" alt="Upload" /></a>
									<a href="{$conf.rooturl_profile}account/avatarwebcam" rel="shadowbox;width=960px;height=640px"><img src="{$imageDir}admin/avatar-btn-webcam.gif" alt="Webcam" /></a>
								</div>
								<div class="form-avatar-buttons-alt"{if $me->avatar == ''} style="display:none;"{/if}>
				                	<a href="{$conf.rooturl_profile}account/avatareditor" rel="shadowbox;width=960px;height=640px"><img src="{$imageDir}admin/avatar-btn-edit.gif" alt="Edit" /></a>
									<a href="javascript:delm('{$conf.rooturl_profile}account?deleteavatar={$smarty.session.avatarDeleteToken}')"><img src="{$imageDir}admin/avatar-btn-delete.gif" alt="Delete" ></a>
				...
				<div class="control-group">
					<label class="control-label" for="ffullname">{$lang.controller.fullname} <span class="star_require">*</span></label>
				...
				<div class="form-actions">
					<input type="submit" name="fsubmit" value="{$lang.default.formSaveSubmit}" class="btn btn-large btn-primary" />
		...
		<div class="tab-pane {if $tab == '2'}active{/if}" id="tab2">
			<div id="profileform" class="myform myformwide stylizedform">
				...
				<div id="profileform" class="myform myformwide stylizedform">
					...
					<form id="form1" name="form1" method="post" action="{$conf.rooturl_profile}account" class="form-horizontal">
					...
					<div class="form-actions">
						<input type="submit" name="fsubmitinfo" value="{$lang.controller.submitLabel}" class="submit btn btn-large btn-primary" />
						<span class="help-inline"><span class="star_require">*</span> : {$lang.default.formRequiredLabel}</span>
					</div>
		...
		<div class="tab-pane {if $tab == '3'}active{/if}" id="tab3">
			...
			<form id="form1" name="form1" method="post" action="{$conf.rooturl_profile}account?tab=3" class="form-horizontal">
				{if $me->email == '' || $me->password == ''}
					{include file="notify.tpl" notifyWarning=$warningCreateNativeUser}
					
					<div class="control-group">
						<label class="control-label" for="fnewpass1">{$lang.controller.newpass1} <span class="star_require">*</span></label>
						<div class="controls"><input type="password" name="fnewpass1" id="fnewpass1" class="input-xlarge"></div>
					</div>
				
					<div class="control-group">
						<label class="control-label" for="fnewpass2">{$lang.controller.newpass2} <span class="star_require">*</span></label>
						<div class="controls"><input type="password" name="fnewpass2" id="fnewpass2" class="input-xlarge"></div>
					</div>
				
				
					<div class="form-actions">
						<input type="submit" name="fsubmitpasswordnew" value="{$lang.default.formSaveSubmit}" class="btn btn-large btn-primary" />
						<span class="help-inline"><span class="star_require">*</span> : {$lang.default.formRequiredLabel}</span>
					</div>
				...
				{else}
					<div class="control-group">
						...
						<div class="controls"><input type="password" name="foldpass" id="foldpass" class="input-xlarge"></div>
					</div>
					...
					<div class="form-actions">
						<input type="submit" name="fsubmitpassword" value="{$lang.default.formSaveSubmit}" class="btn btn-large btn-primary" />
						<span class="help-inline"><span class="star_require">*</span> : {$lang.default.formRequiredLabel}</span>
					</div>
				{/if}
