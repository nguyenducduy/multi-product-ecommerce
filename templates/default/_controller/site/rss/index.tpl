...
<rss version="2.0"
	...
	<channel>
		<title>Siêu thị điện máy dienmay.com
</title>
		...
		<item>
			...
			<link>{$news->getNewsPath()}</link>
			<pubDate>{$news->datecreated|date_format:$lang.default.dateFormatRssSmarty}</pubDate>
			<dc:creator>{$news->getActorName()}</dc:creator>
					<category><![CDATA[{$news->getNewscategoryname()}]]></category>

			<description><![CDATA[{$news->content|@strip_tags|truncate}]]></description>
		</item>
		{/foreach}
	</channel>
</rss>