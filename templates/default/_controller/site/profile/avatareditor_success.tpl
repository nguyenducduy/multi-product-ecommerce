...
<style type="text/css">
{literal}
body{background-color:#fff; font-family:"Segoe UI", Tahoma, Geneva, sans-serif; font-size:11px;}
{/literal}
</style>
...
<script type="text/javascript">
    ...
    {literal}{{/literal}
        self.parent.$(".form-avatar-image img").attr("src", "{$me->getSmallImage()}?t={$smarty.now}" + (new Date()).getTime());
		self.parent.$("#panelleft .headingbox .avatarimg").attr("src", "{$me->getSmallImage(1)}?t={$smarty.now}" + (new Date()).getTime()); 
