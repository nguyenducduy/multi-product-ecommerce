...
<script type="text/javascript" src="{$currentTemplate}js/jquery.imgareaselect.min.js" ></script>
...
{include file="notify.tpl" notifyError=$error notifySuccess=$success}
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
			...
			self.parent.$(".form-avatar-image img").attr("src", "{/literal}{$setting.avatar.imageDirectory}{$me->thumbImage()}{literal}?" + (new Date()).getTime()); 
