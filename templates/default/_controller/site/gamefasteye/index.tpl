...
$(document).ready(function(){
      ...
      $('.yt_like').html('<iframe src="https://www.facebook.com/plugins/like.php?href= &width=120&height=21&colorscheme=light&layout=button_count&action=like&show_faces=true&send=false" scrolling="no" frameborder="0" allowTransparency="true" class="likepage"></iframe>');
       {literal}
