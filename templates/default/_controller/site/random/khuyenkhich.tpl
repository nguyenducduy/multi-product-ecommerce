...
<div id="wrapper">   
    <div class="">
		<div class="giarerandom">
			<a href="{$conf.rooturl}random">Quay số chọn giải chính</a> |
			<span>Quay số chọn giải khuyến khích</span>
		</div>        
		<br /><br />
	    <h1>QUAY SỐ NGẪU NHIÊN CHỌN GIẢI KHUYẾN KHÍCH</h1>
		
		{if $randomcode != ''}
			<div class="giarewinner">
				<h2>Mã ngẫu nhiên dùng cho giải khuyến khích: <big>{$randomcode}</big></h2>
				
				<div class="khuyenkhichlist">
					<h3>Danh sách trúng giải khuyến khích</h3>
