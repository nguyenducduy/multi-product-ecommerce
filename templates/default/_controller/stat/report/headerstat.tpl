...
<html lang="en">
  <head>
		...
		<script type="text/javascript" src="{$currentTemplate}js/stat/report/jquery.tablesorter.min.js"></script>		
		<script type="text/javascript" src="{$currentTemplate}js/stat/report/jquery-calx-1.1.4.min.js"></script>
