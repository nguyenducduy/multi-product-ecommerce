...
<form action="" method="get">
    ...
    <div>
        ...
        <a style="font-style:italic;" href="{$conf.rooturl}stat/report/productcategory/subcatepricesegment{$paramurl}" class="btn btn-primary">Phân khúc giá</a>        
    ...
    <div id="dataTable">            
        <table class="table table-bordered tablesorter" id="data">
            ...
            {$tongsomodels = 0}
            {foreach from=$listsegdata item=product name=productlists}           
                <tr>
                    <td>{$smarty.foreach.productlists.iteration}</td>                   
                    <td><a title="{$product.tenphankhuc}" href="{$conf.rooturl}stat/report/productcategory/subcate{$paramurl}&a=gia,{$product.nameseo}">{$product.tenphankhuc}</a></td>
                    ...
                    <td class="numberdata">{$product.giabanchuavat|number_format}</td>
                    <td class="numberdata">{$product.giabancovat|number_format}</td>
                ...
                {math assign="tongngaybanhang" equation="x + y" x=$tongngaybanhang y=$product.ngaybanhang format="%.2f"}
            {/foreach}
            </tbody>
            <tfoot>
            	<tr>
...
{/literal}
<script type="text/javascript" src="https://ecommerce.kubil.app/templates/default/js/stat/report/subcatesegment.js"></script>
