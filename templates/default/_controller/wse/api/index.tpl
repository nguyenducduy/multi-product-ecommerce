...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="{$currentTemplate}js/jquery.jsonview.js"></script>
		...
		<link rel="stylesheet" href="{$currentTemplate}css/jquery.jsonview.css" type="text/css" media="screen" />
	</head>

	<body>
		<h1>API Documentations :: ENTERPRISE</h1>

		<div id="apidocbaseurl" style="display:none;">BASE_URL: <span>http://{$conf.host}</span></div>
