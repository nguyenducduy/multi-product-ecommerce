...
<div class="page-header" rel="menu_newsletter_unscriber"><h1>{$lang.controller.head_edit}</h1></div>
...
<input type="hidden" name="ftoken" value="{$smarty.session.newsletterunscriberEditToken}" />
