...
Class Controller_Crm_Ticket Extends Controller_Crm_Base
{
	...
	public function indexAction()
	{
		...
		$arr["txtSearch"] = '';
		$arr["startDate"] = '01-10-2012';
		$arr["endDate"] = '01-10-2012';
		$arr["PageNumber"] = '1';
		$arr["isOfMe"] = '0';
		$arr["stCallCenterUser"] = '0';
		$arr["intCATEGORYID"] = '0';
		$arr["intCATEGORYTOPICID"] = '0';
		$arr["statusid"] = '0';
		$arr["isOfDep"] = '0';
		$arr["intSearchType"] = '0';
		...
		{
			var_dump(json_decode(utf8_encode($item)));
			//var_dump($item);
		}
		var_dump(json_decode($rs));*/
//		$result[] = '{"ticketID":402282,"channelID":3,"categoryID":2,"topicID":21,"customerID":1010820538,"customerPhone":"0913307053","customerEmail":"","customerName":"Nguy?n V?n Th?ng","customerNote":"h?i gi  HTC One X","updatedUser":"14007","updatedDate":"\/Date(1349880928000+0700)\/","updatedUserNote":"","priorityID":2,"statusID":6,"afterSatisfyscore":3,"createdUser":"14007","leadID":0,"topicName":"H? tr? kh c","priorityName":"B nh th??ng"}';
		//var_dump($result);
		//var_dump(json_decode($result[2], true));
	/*foreach($rs as  $k => $v)
		{
				$arrDecode[] = json_decode($v,true);
		}
		var_dump($arrDecode);*/
