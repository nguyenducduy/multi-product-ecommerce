...
/**
 * core/backend/class.scrumstorycategory.php
 *
 ...
 */
Class Core_Backend_ScrumStoryCategory extends Core_Backend_Object
{
    ...
    public static function getScrumStoryCategoryProject($where = ''){
        $db3 = self::getDb();
        $sql = 'SELECT
                ssc.ssc_id,
                ssc.sp_id,
