...
/**
 * core/backend/class.notpermissionlink.php
 *
 ...
 */
Class Core_Backend_Notpermissionlink extends Core_Backend_Object
{
	...
	public function getData($id)
	{
		...
		$this->trackingid = $row['n_trackingid'];
	...
	public static function getList($where, $order, $limit = '')
	{
		...
		while($row = $stmt->fetch())
		{
			...
			$myNotpermissionlink->trackingid = $row['n_trackingid'];
	...
	public static function getNotpermissionlinks($formData, $sortby, $sorttype, $limit = '', $countOnly = false)
	{
		...
		if($formData['ftrackingid'] != '')
			$whereString .= ($whereString != '' ? ' AND ' : '') . 'n.n_trackingid = "'.Helper::unspecialtext((string)$formData['ftrackingid']).'" ';
