...
Class Core_Backend_Session extends Core_Backend_Object
{
	public $id = '';
	public $data = '';
	public $agent = '';
	...
	public function getData($id)
	{
		...
		$this->actor = new Core_User($row['s_userid'], true);
	...
	public static function getList($where, $order, $limit = '', $getUserDetail = false, $isDistinct = false)
	{
		...
		while($row = $stmt->fetch())
		{
			...
			if($getUserDetail)
			{
				$mySession->actor = new Core_User($row['s_userid'], true);
			}
