...
Class Core_Backend_Notification_FeedLikeFollow extends Core_Backend_Notification
{
	public $feedpath = '';
	public $summary = '';
	...
	{
		parent::__construct(); 
		$this->type = parent::TYPE_FEED_LIKE_FOLLOW;               
	}
	...
	*/
	...
	public function showDetail($display = false)
	{
		...
		if($this->summary != '')
		{
			$this->summary = $registry->lang['controller']['notificationFeedLikeFollowLinkTextSummary'] . ' <em>' . $this->summary . '</em>' . $registry->lang['controller']['notificationFeedLikeFollowLinkTextSummarySuffix'];
		}
		else
		{
			$this->summary = $registry->lang['controller']['notificationFeedLikeFollowLinkText'];
		}
		
		
		$out = '<a class="notifyitem" href="'.$this->feedpath.'" title="'.$registry->lang['controller']['notificationFeedDetailTitle'].'">'.$actorInfo .$registry->lang['controller']['notificationFeedLikeFollowText'].' '.$this->summary.'</a>';
