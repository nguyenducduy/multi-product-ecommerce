...
/**
 * core/class.notpermission.php
 *
 * File contains the class used for Notpermission Model
 *
 * @category Litpi
 * @package Core
 ...
 */
Class Core_Notpermission extends Core_Object
{
    ...
    public function addData()
    {
		...
		$sql = 'INSERT INTO ' . TABLE_PREFIX . 'notpermission (
					u_id,
					n_sessionid,
					n_referer,
					n_ipaddress,
	...
	public function updateData()
	{
		...
		$sql = 'UPDATE ' . TABLE_PREFIX . 'notpermission
				SET u_id = ?,
					n_sessionid = ?,
					n_referer = ?,
					n_ipaddress = ?,
	...
	{
		$id = (int)$id;
		$sql = 'SELECT * FROM ' . TABLE_PREFIX . 'notpermission n
				WHERE n.n_id = ?';
	...
	{
		$sql = 'DELETE FROM ' . TABLE_PREFIX . 'notpermission
				WHERE n_id = ?';
	...
	public static function countList($where)
	{
		...
		$sql = 'SELECT COUNT(*) FROM ' . TABLE_PREFIX . 'notpermission n';
	...
	public static function getList($where, $order, $limit = '')
	{
		...
		while($row = $stmt->fetch())
		{
			...
			$myNotpermission->uid = $row['u_id'];
			$myNotpermission->id = $row['n_id'];
			$myNotpermission->sessionid = $row['n_sessionid'];
			$myNotpermission->referer = $row['n_referer'];
			$myNotpermission->ipaddress = $row['n_ipaddress'];
			$myNotpermission->useragent = $row['n_useragent'];
			$myNotpermission->datecreated = $row['n_datecreated'];
			$myNotpermission->datemodified = $row['n_datemodified'];


            $outputList[] = $myNotpermission;
        }
	 ...
	 *
	 */
	public static function getNotpermissions($formData, $sortby, $sorttype, $limit = '', $countOnly = false)
	{
		$whereString = '';
