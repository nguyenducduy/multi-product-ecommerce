...
Class Core_MutualfriendTask extends Core_Object
{
	public $id = 0;
	...
	*/
	public static function cacheGet($userid, &$cacheSuccess = false, $forceStore = false)
	{
		...
		$myMutualfriendTask = new Core_MutualfriendTask();
	...
	*/
	public static function cacheSet($userid, $value)
	{
		...
		return apc_store(self::cacheBuildKeystring($userid), $value, $registry->setting['site']['apcUserCacheTimetolive']);
	}
	...
	*/
	...
	{
		return apc_delete(self::cacheBuildKeystring($userid));
	}
