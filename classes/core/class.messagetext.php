...
Class Core_MessageText extends Core_Object
{
	 ...
	 */
	public function getForwardedText(Core_Message $myMessage, Core_User $sender, $recipientList)
	{
		global $lang;
	 ...
	 */
	public function getQuotedText(Core_Message $myMessage, Core_User $sender)
	{
		global $lang;
