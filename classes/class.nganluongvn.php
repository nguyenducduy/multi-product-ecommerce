...
class NganluongVn 
{
	...
	public function __construct($merchantcode, $merchantpass, $checkouturl = 'https://www.nganluong.vn/checkout.php')
	{
		$this->merchant_site_code = $merchantcode;
		$this->secure_pass = $merchantpass;
		$this->nganluong_url = $checkouturl;
	}
