...
<div class="page-header" rel="menu_giarereviewthumb"><h1>{$lang.controller.head_edit}</h1></div>

<div class="navgoback"><a href="{$redirectUrl}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal">
<input type="hidden" name="ftoken" value="{$smarty.session.giarereviewthumbEditToken}" />
	...
	<div class="control-group">
		<label class="control-label" for="fdatecreared">{$lang.controller.labelDatecreared}</label>
		<div class="controls"><input type="text" name="fdatecreared" id="fdatecreared" value="{$formData.fdatecreared|@htmlspecialchars}" class="input-mini"></div>
	</div>
