...
* 
* Cac string xem set la badstring: ......, aaaaaaaaaa, bbbbbbbb, cccccccccccc, asdf, asdfasdlfk, kljlkjkl, werqewrsdf, asdfasdf...
*/
	...
	*/
	public static function isbad($s)
	{
		...
		else
		{
			...
			$pattern = array('asdf', 'asf', 'jkl', 'ajk', 'download', 'http', '..........', '@yahoo', '@gmail', 'muon mua', 'muon xem', 'mua o dau', 'xem o dau', 'muốn mua', 'muốn xem');
