...
<div class="page-header" rel="menu_feedback"><h1>{$lang.controller.head_add}</h1></div>

<div class="navgoback" onclick="redirect('{$conf.rooturl_cms}feedback')"><a href="#">Xem tất cả Feedback</a></div>

<form action="" method="post" name="myform" class="form-horizontal" enctype="multipart/form-data">
<input type="hidden" name="ftoken" value="{$smarty.session.feedbackAddToken}" />
	...
	<div class="control-group">
		...
		<div class="controls"><input type="file" name="ffilepath" id="ffilepath" value="{$formData.ffilepath|@htmlspecialchars}" class="input-xlarge"></div>
	</div>
