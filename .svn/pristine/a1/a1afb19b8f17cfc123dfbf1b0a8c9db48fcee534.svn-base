...
Class Core_GoogleAnalytics_Visitor extends Core_GoogleAnalytics
{
	public $title = 'Visitor';
	...
	{
		$data = array();
		$this->analytics->requestReportData($profileid,array('date'),array('visitors'), null, null, $datestart, $dateend);
