...
<div class="page-header" rel="menu_lotteevent"><h1>{$lang.controller.head_edit}</h1></div>

<div class="navgoback"><a href="{$redirectUrl}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal">
<input type="hidden" name="ftoken" value="{$smarty.session.lotteeventEditToken}" />
	...
	<div class="control-group">
		<label class="control-label" for="fcategoryid">{$lang.controller.labelStatus}</label>
		<div class="controls">
