...
<input type="hidden" name="ftoken" value="{$smarty.session.productquestionAddToken}" />
	...
	<div class="control-group">
		...
		<div class="controls">
			<label class="checkbox" style="float: left;">
                <input style="margin-top: -2px;" type="radio" name="ftype" id="ftype" value="0" checked="checked"/> Radio
            </label>
            <label class="checkbox" style="float: left;margin-top: 5px;">
                <input style="margin-top: -2px;" type="radio" name="ftype" id="ftype" value="1" /> Text
            </label>
		</div>
	</div>	
	...
	<div class="control-group">
		<label class="control-label" for="fanswer">Câu trả lời 1<span class="star_require">*</span></label>
		<div class="controls"><input style="float:left" type="text" name="fanswer[]" id="fanswer" value="" class="input-xlarge">
		<label class="checkbox" style="float: left; margin-top: 5px;">
                <input style="margin-top: -2px;" type="radio" name="fcorrect" id="fcorrect" value="1" /> Câu trả lời đúng
            </label>
		</div>
	...
	<div class="control-group">
		<label class="control-label" for="fanswer">Câu trả lời 2<span class="star_require">*</span></label>
		<div class="controls"><input style="float:left" type="text" name="fanswer[]" id="fanswer" value="" class="input-xlarge">
		<label class="checkbox" style="float: left;margin-top: 5px;">
                <input style="margin-top: -2px;" type="radio" name="fcorrect" id="fcorrect" value="2" /> Câu trả lời đúng
            </label>
		</div>
	...
	<div class="control-group">
		<label class="control-label" for="fanswer">Câu trả lời 3<span class="star_require">*</span></label>
		<div class="controls"><input style="float:left" type="text" name="fanswer[]" id="fanswer" value="" class="input-xlarge">
		<label class="checkbox" style="float: left;margin-top: 5px; ">
                <input style="margin-top: -2px;" type="radio" name="fcorrect" id="fcorrect" value="3" /> Câu trả lời đúng
            </label>
		</div>
