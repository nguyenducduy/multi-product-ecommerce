...
/**
 * core/backend/class.relcalendareventuser.php
 *
 ...
 */
Class Core_Backend_RelCalendarEventUser extends Core_Backend_Object
{
	...
	public static function getList($where, $order, $limit = '')
	{
		...
		{
			$myRelCalendarEventUser = new Core_Backend_RelCalendarEventUser();
