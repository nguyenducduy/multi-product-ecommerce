...
Class Core_GoogleAnalytics_Bounce extends Core_GoogleAnalytics
{
	public $title = 'Bounce';
	...
	{
		$data = array();
		$this->analytics->requestReportData($profileid,array('date'),array('bounces'), null, null, $datestart, $dateend);
