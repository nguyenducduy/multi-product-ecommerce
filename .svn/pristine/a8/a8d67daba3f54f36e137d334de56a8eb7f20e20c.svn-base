<ul class="breadcrumb">
    ...
    <li><a href="{$conf.rooturl}{$controllerGroup}/{$controller}">Thương hiêu - Ngành hàng</a> <span class="divider">/</span></li>
...
<form action="" method="post" name="myform" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="control-group">
        ...
        <div class="controls"><textarea name="fseodescription" id="fseodescription" rows="7" class="mceNoEditor input-xxlarge">{$formData.fseodescription}</textarea>Còn lại <span id="fdesccol1counter">200</span> ký tự</div>
    </div>
    <!-- Column new -->
