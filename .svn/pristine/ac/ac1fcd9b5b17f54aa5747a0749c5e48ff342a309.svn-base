...
Class Controller_Admin_SessionManager Extends Controller_Admin_Base 
{
	...
	public function indexAction()
	{
		...
		if(isset($_POST['btnDel']))
		{
			...
			else 
			{
				...
				{
					$mySession = new Core_Backend_Session();
					$mySession->id = $id;
					if($mySession->delete())
					{
						$successCount++;
		...
		//tim tong so record
		$total = Core_Backend_Session::getSessions($formData, $sortby, $sorttype, 0, true, true, true);
		$totalPage = ceil($total/$this->recordPerPage);
		$curPage = $page;
		
		$entries = Core_Backend_Session::getSessions($formData, $sortby, $sorttype, (($page - 1)*$this->recordPerPage).','.$this->recordPerPage, false, true, true);
		...
		$memberOnline = Core_Backend_Session::countmemberonline();
	...
	public function indexfullAction()
	{
		...
		//tim tong so record
		$total = Core_Backend_Session::getSessions($formData, $sortby, $sorttype, 0, true, true);
		$totalPage = ceil($total/$this->recordPerPage);
		$curPage = $page;
		
		$entries = Core_Backend_Session::getSessions($formData, $sortby, $sorttype, (($page - 1)*$this->recordPerPage).','.$this->recordPerPage, false, true);
	...
	public function detailAction()
	{
		...
		$mySession = new Core_Backend_Session($sessionid);
		if($mySession->id != '')
		{
