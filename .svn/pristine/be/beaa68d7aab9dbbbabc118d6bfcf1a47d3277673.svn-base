...
<div class="page-header" rel="menu_gamefasteye"><h1>{$lang.controller.head_edit}</h1></div>

<div class="navgoback"><a href="{$redirectUrl}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal">
<input type="hidden" name="ftoken" value="{$smarty.session.gamefasteyeEditToken}" />
	...
	<div class="control-group">
		...
		<div class="input-append bootstrap-timepicker">
	            <input id="ftime" type="text"  placeholder="H:m:s" name="ftime" value="{$formData.ftime}" class="input-small timepicker">
