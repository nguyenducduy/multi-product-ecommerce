...
<div class="page-header"><h1 style="display:inline;">Edit giá đối thủ offline</h1>
...
<input type="hidden" name="ftoken" value="{$smarty.session.priceenemyEditToken}" />
	...
	<div class="control-group">
		...
		<div class="controls"><input type="text" name="fpid" id="fpid" readonly="true" value="{$formData.fpid}" class="input-mini"></div>
	</div>	
