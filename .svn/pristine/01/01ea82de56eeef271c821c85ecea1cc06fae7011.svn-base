    ...
    function loaddata2()
    {
		...
		var formularcellRender = function (instance, td, row, col, prop, value, cellProperties) {
	        ...
	        $dataTable.handsontable({
	            data: data,
	            colWidths: [40, 40 , 170 ,  170 , 100 , 100 , 300 , 100 , 100 ,100 , 100, 100 , 100 , 100 ,100 , 100 ,100 ,100, 100 ,100], //can also be a number or a function
	            colHeaders: ["Year" , "Month" , "Category" , '<span class="dropsubcategory2">Sub Category</div>', '<span class="titledropdown2">Brand</span>', "Barcode" , "SKU Name" , "Sales Vol" , "Sales Rev" , "ProF" ,'GrossMargin' ,  "Vol Cont" , "Rev Cont","ProF cont" , "Vol. Rank" , "Rev. Rank" , "ProF. Rank" , "Margin Rank"],
	            stretchH: 'all',
	            //contextMenu: true,
	            fixedColumnsLeft: 7,
