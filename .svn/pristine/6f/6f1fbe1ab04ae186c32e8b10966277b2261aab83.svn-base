...
<div class="page-header" rel="menu_crazydeal"><h1>{$lang.controller.head_add}</h1></div>

<div class="navgoback"><a href="{$redirectUrl}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal" enctype="multipart/form-data">
<input type="hidden" name="ftoken" value="{$smarty.session.crazydealAddToken}" />
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="file" name="fimage" id="fimage" class="input-xlarge">
		</div>
	</div>
