<ul class="breadcrumb">
	...
	<li><a href="{$conf.rooturl_admin}{$controller}">Log</a> <span class="divider">/</span></li>
	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="tab2">
			<form class="form-inline" action="" method="post" onsubmit="return false;">
				...
				Object ID:
				<input type="text" name="fmainid" id="fmainid" size="20" value="{$formData.fmainid|@htmlspecialchars}" class="" /> -
