...
<div class="page-header" rel="menu_productcolor"><h1>{$lang.controller.head_edit}</h1></div>

<div class="navgoback"><a href="{$redirectUrl}">{$lang.default.formBackLabel}</a></div>

<form action="" method="post" name="myform" class="form-horizontal">
<input type="hidden" name="ftoken" value="{$smarty.session.productcolorEditToken}" />
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="fcode" id="fcode" value="{$formData.fcode}" />		
		</div>
	</div>
