...
<div id="container">
	<div class="newscont">
        ...
        <div class="newsmid">
            ...
            <div class="newsbar">
                <div class="newsbartitle"><span>{$myCategory->name}</span></div>
                {foreach item=mynews from=$myNews}
                <div class="newslist">
                    <a href="{$mynews->getNewsPath()}" title="{$mynews->title}"><img src="{$mynews->getSmallImage()}" alt="{$mynews->title}" title="{$mynews->title}" /></a>
                    <a href="{$mynews->getNewsPath()}" title="{$mynews->title}">{$mynews->title}</a>
                    <p>{$mynews->content|strip_tags|truncate:155}</p>
                    <div><a href="javascript:void(0)"><i class="icon-usernews"></i>{if $mynews->uid > 0}{$mynews->getActorName()}{else}dienmay.com{/if}</a> |</div>
            ...
            <div class="pagination" style="float: right;position:relative;top: 0px;height:50px;">
